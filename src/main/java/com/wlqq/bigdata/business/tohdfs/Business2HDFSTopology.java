 ...
 *
 */
public class Business2HDFSTopology {
	
	private static final Log logger = LogFactory.getLog(Business2HDFSTopology.class);
	
	public static void main(String[] args) throws ClassNotFoundException{
		
        //以storm和kafka相关参数的配置文件作为参数		
		if(args.length!=1){
			System.err.println("Usage:./bin/storm jar xxx.jar com.wlqq.bigdata.business.tohdfs.Business2HDFSTopology xxxxx.yaml");
			System.exit(0);
		}
...
//		com.wlqq.bigdata.storm.hdfs.bolt.rotation.PartitionByHourPolicy.Units.MB,intervalHour);
        ...
        .shuffleGrouping("parse-json", Utils.FAILED_UNEXPECTED_STREAM)
