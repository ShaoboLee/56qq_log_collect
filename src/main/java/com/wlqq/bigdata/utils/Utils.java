...
public class Utils {
	...
	public static final String LOADER_PARALLELISM_3 = "storm.bolt3.parallelism";
	public static final String LOADER_PARALLELISM_4 = "storm.bolt4.parallelism";
	...
	public static final String TOPOLOGY_SUSPEND_TIME_SEC = "topology.suspend.time.sec";
	...
	public static final String STORM_KAFKA_COLLECTOR_ACK = "storm-kafka.collector.ack";
	...
	public static final String MONITOR_TOPIC = "monitor.topic";
	...
	public static final String KAFKA_WRITE_FAIL_THRESHOLD = "kafka.write.fail.threshold";
	...
	public static final String THREAD_QUEUE_PERCENT = "user.bolt.queue.percent";
	public static final String THREAD_QUEUE_SLEEP_MS = "user.bolt.queue.sleep.ms";
	
	//stream
	public static final String KAFKA_WRITE_FAIL_STREAM = "kafka-write-fail";
	public static final String KAFKA_WRITE_DATA_STREAM = "kafka-write-data";
	public static final String WRITE_TO_ES_STREAM = "write-to-es";
	public static final String UNKNOWN_TOPIC_STREAM = "unknown-topic";
