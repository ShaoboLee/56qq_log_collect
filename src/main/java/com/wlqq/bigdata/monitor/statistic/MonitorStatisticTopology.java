...
public class MonitorStatisticTopology {

	private static final Log logger = LogFactory.getLog(MonitorStatisticTopology.class);

	public static void main(String[] args) throws ClassNotFoundException{
		
		if(args.length!=1){
			System.err.println("Usage:./bin/storm jar xxx.jar com.wlqq.bigdata.es.MonitorStatisticTopology xxxxx.yaml");
			System.exit(0);
		}
